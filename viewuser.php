...
$userid = isset($_GET['id']) ? $_GET['id'] :  header('location:./index.php');
//read from file
...
if( isset($userdata[$userid]) ){
    ...
    <div class="container-list">
        ...
        <ul class="list">
            ...
            <li><span class="label-info">Skills</span><span class="label-data"><?= $column[3]?> </span></li>
            <li><span class="label-info">Gender:</span><span class="label-data"><?= $column[4]?> </span></li>
